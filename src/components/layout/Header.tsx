							...
							<div ref={userRef} className="relative hidden md:block">
								...
								>
									...
									<span className="max-w-[120px] truncate">
										{authUser.username || authUser.email || "Compte"}
									</span>
									<ChevronDown
										className={`w-3 h-3 transition-transform duration-300 ${userOpen ? "rotate-180" : ""}`}
									/>
								</button>
								{userOpen && (
